...
type SysPost struct {
	...
	PostCode   string     `gorm:"column:post_code;type:varchar(64);comment:'岗位编码';NOT NULL" json:"postCode"`         // 岗位编码
	PostName   string     `gorm:"column:post_name;type:varchar(50);comment:'岗位名称';NOT NULL" json:"postName"`         // 岗位名称
